...
class Overveiw extends Component{
    ...
    render(){
        console.log(this.state.modalTags)
        ...
        return (
            <div>
                ...
                {(this.state.isOpen) ?
                <Modal row={this.state.activeButton} total={this.state.total} modalTags={this.state.modalTags} receiptId={this.state.receiptId} data={this.state.data} close={this.close}/>
                 : null 
                }
